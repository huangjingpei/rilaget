...
export const SUPPORTED_PLATFORMS: PlatformInfo[] = [
  ...
  plat({
    ...
    color: '#0084ff',
    icon: 'Tv',
    urlPattern: 'miguvideo\\.com|migu\\.cn',
    sampleUrls: ['https://www.miguvideo.com/'],
    requiresCookieForHighRes: true,
    defaultFormat: 'm3u8',
    parseWired: true,
    supportsVod: true,
  ...
  plat({
    ...
    color: '#ff6699',
    icon: 'Music2',
    urlPattern: 'missevan\\.com',
    sampleUrls: ['https://www.missevan.com/live/'],
    requiresCookieForHighRes: false,
    defaultFormat: 'flv',
    parseWired: true,
  }),
  plat({
    ...
    color: '#e60026',
    icon: 'Radio',
    urlPattern: 'look\\.163\\.com',
    sampleUrls: ['https://look.163.com/live/'],
    requiresCookieForHighRes: false,
    defaultFormat: 'flv',
    parseWired: true,
  }),
  plat({
    ...
    color: '#0088ff',
    icon: 'RadioTower',
    urlPattern: 'twitcasting\\.tv',
    sampleUrls: ['https://twitcasting.tv/'],
    requiresCookieForHighRes: false,
    defaultFormat: 'm3u8',
    parseWired: true,
  }),
  plat({
    ...
    color: '#2bb673',
    icon: 'Sparkles',
    urlPattern: 'showroom-live\\.com',
    sampleUrls: ['https://www.showroom-live.com/'],
    requiresCookieForHighRes: false,
    defaultFormat: 'm3u8',
    parseWired: true,
  }),
